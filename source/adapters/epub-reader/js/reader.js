...
EPUBJS.Reader = function(bookPath, _options) {
  ...
  this.rendition.themes.register("dark", "css/themes.css");
  this.rendition.themes.register("light", "css/themes.css");
...
EPUBJS.reader.BookmarksController = function() {
    ...
    var allTOCItems = {};
    function iterateTOCItems(tocItems) {
      tocItems.forEach(function(tocItem){
        allTOCItems[tocItem.href] = tocItem.label;
        if (tocItem.subitems.length > 0) {
          iterateTOCItems(tocItem.subitems);
        }
      });
    }

    iterateTOCItems(book.navigation.toc);
    var spineItemHref = spineItem.href;
    var matchedLabel = allTOCItems[spineItemHref];
    if (matchedLabel) {
...
EPUBJS.reader.ControlsController = function(book) {
	...
	*/
    ...
    reader.trigger("reader:page", cfi);
	});
